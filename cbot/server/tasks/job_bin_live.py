...
class JobBinLive(JobStrategy):
    ...
    async def runner(self, task: Task, client):
        printer = task.printer
        ...
        if 'klines' in task_data.streams:
            ...
            for symbol in symbols:
                ...
                sorted_output = self.calc_output(data, output, symbol)
    ...
    def calc_output(self, data, output, symbol):
